...
class DailyData(models.Model):
    ...
    closing_price = models.DecimalField(max_digits=5, decimal_places=3)
    predicted_next_day_closing_price = models.DecimalField(max_digits=5, decimal_places=3)
    yesterdays_closing_price = models.DecimalField(max_digits=5, decimal_places=3)
    change = models.DecimalField(max_digits=5, decimal_places=3)
    trade = models.IntegerField()
    value_mn = models.DecimalField(max_digits=5, decimal_places=3)
